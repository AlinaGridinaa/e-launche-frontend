      ...
      <div className="px-4 -mt-4">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full bg-gradient-to-br from-[#FF6B35] to-[#F7931E] rounded-2xl p-4 shadow-sm flex items-center justify-between hover:shadow-md transition-all"
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-semibold text-white">Push-нотифікації</p>
                <p className="text-xs text-white/80">Відправити повідомлення студентам</p>
              </div>
            </div>
